...
const fixtureRoot = path.join(import.meta.dirname, "fixtures", "sample-plugin")
const mcpFixtureRoot = path.join(import.meta.dirname, "fixtures", "mcp-file")
const customPathsRoot = path.join(import.meta.dirname, "fixtures", "custom-paths")
const invalidCommandPathRoot = path.join(import.meta.dirname, "fixtures", "invalid-command-path")
const invalidHooksPathRoot = path.join(import.meta.dirname, "fixtures", "invalid-hooks-path")
const invalidMcpPathRoot = path.join(import.meta.dirname, "fixtures", "invalid-mcp-path")
